...
public class NumeroTest {
    ...
    public void IncrementarTest(){
        Numero t = new Numero(new AbstractMap.SimpleEntry<>(1, 1),new BigDecimal("5.4"),true,2, Tipus_Numero.numero);
        t.incrementar();
    ...
    public void PotenciaTest() {
        Numero t = new Numero(new AbstractMap.SimpleEntry<>(1, 1),new BigDecimal("2"), true, 2, Tipus_Numero.numero);
        t.potencia(2.0);
    ...
    public void PotenciaTresDecimalsTest() {
        Numero t = new Numero(new AbstractMap.SimpleEntry<>(1, 1),new BigDecimal("2.563"), true, 2, Tipus_Numero.numero);
        t.potencia(2.0);
        t.setDecimals();
    ...
    public void PotenciaComplicada() {
        Numero t = new Numero(new AbstractMap.SimpleEntry<>(1, 1), new BigDecimal(-2.565), true, 3, Tipus_Numero.numero);
        t.potencia(6.0);
        t.setDecimals();
    ...
    public void ArrelTest() {
        Numero t = new Numero(new AbstractMap.SimpleEntry<>(1, 1),new BigDecimal(4), true, 2, Tipus_Numero.numero);
        t.arrel(2.0);
